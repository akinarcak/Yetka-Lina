...
export function saveMessageFeedback(conversationId, messageId, data) {
  return quietRequest({
    url: `${CHAT_AI_BASE}/conversations/${conversationId}/messages/${messageId}/feedback/`,
    method: 'post',
    data
  })
}

export function deleteMessageFeedback(conversationId, messageId) {
  return quietRequest({
    url: `${CHAT_AI_BASE}/conversations/${conversationId}/messages/${messageId}/feedback/`,
    method: 'delete'
  })
